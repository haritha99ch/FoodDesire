...
public sealed partial class DeliveriesPage : Page {
    ...
    private void PreparedOrders_DragItemsStarting(object sender, DragItemsStartingEventArgs e) {
    ...
    private async void UserOrders_Drop(object sender, DragEventArgs e) {
    ...
    private void UserOrders_DragOver(object sender, DragEventArgs e) {
        e.AcceptedOperation = DataPackageOperation.Move;
    }

    private async void UserOrders_ItemClick(object sender, ItemClickEventArgs e) {
