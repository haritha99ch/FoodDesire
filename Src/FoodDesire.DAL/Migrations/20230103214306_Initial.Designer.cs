...
namespace FoodDesire.DAL.Migrations
{
    ...
    [Migration("20230103214306_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDesire.Models.Deliverer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDesire.Models.Delivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDesire.Models.Delivery", b =>
                {
                    ...
                    b.HasOne("FoodDesire.Models.Deliverer", "Deliverer")
                        .WithMany("Deliveries")
                    ...
                    b.HasOne("FoodDesire.Models.Order", "Order")
                        .WithOne()
                        .HasForeignKey("FoodDesire.Models.Delivery", "OrderId")
                        .IsRequired();
            ...
            modelBuilder.Entity("FoodDesire.Models.FoodItem", b =>
                {
                    ...
                    b.HasOne("FoodDesire.Models.Order", null)
                        .WithMany("FoodItems")
                        .HasForeignKey("OrderId");

                    b.HasOne("FoodDesire.Models.Recipe", "Recipe")
                        .WithOne()
                        .HasForeignKey("FoodDesire.Models.FoodItem", "RecipeId")
                        .IsRequired();

                    b.OwnsMany("FoodDesire.Models.FoodItemIngredient", "FoodItemIngredients", b1 =>
                        {
                            ...
                            b1.Property<int>("RecipeIngredientId")
                                .HasColumnType("int");

                            b1.HasKey("FoodItemId", "Id");

                            b1.ToTable("FoodItem");

                            b1.ToJson("FoodItemIngredients");
